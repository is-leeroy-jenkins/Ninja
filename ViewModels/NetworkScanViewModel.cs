...
using static Ninja.Models.NetworkScanModel;
...
namespace Ninja.ViewModels
{
    ...
    internal class NetworkScanViewModel : MainWindowBase
    {
        ...
        public NetworkScanModel.NetInterfaceInfo[] GetLocalNetworkInterface()
        {
            NetworkInterface[] interfaces = NetworkInterface.GetAllNetworkInterfaces();
            int len = interfaces.Length;
            NetworkScanModel.NetInterfaceInfo[] info = new NetworkScanModel.NetInterfaceInfo[len];
                ...
                if (ni.OperationalStatus == OperationalStatus.Up)
                {
                    ...
                    foreach (UnicastIPAddressInformation ip in property.UnicastAddresses)
                    {
                        if (ip.Address.AddressFamily == System.Net.Sockets.AddressFamily.InterNetwork)
                        {
                            ...
                            info[j] = new NetworkScanModel.NetInterfaceInfo();
