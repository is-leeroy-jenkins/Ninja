...
using Ninja.Views;
using AWSSessionManager = Ninja.Profiles.Application.AWSSessionManager;
...
namespace Ninja.ViewModels
{
    ...
    using Utilities;
    using Views;
    using AWSSessionManager = Profiles.Application.AWSSessionManager;
    ...
    public class AWSSessionManagerHostViewModel : ViewModelBase, IProfileManager
    {
        ...
        {
            var sessionInfo = Ninja.Profiles.Application.AWSSessionManager.CreateSessionInfo(SelectedProfile);
