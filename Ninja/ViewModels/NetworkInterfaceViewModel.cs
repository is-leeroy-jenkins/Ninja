...
using Ninja.Models;
using Ninja.Models.EventSystem;
...
using Ninja.Views;
using Network_NetworkInterface = Ninja.Models.Network.NetworkInterface;
using NetworkInterface = Ninja.Models.Network.NetworkInterface;
...
using Utilities;
using Views;
using BandwidthMeter = Models.Network.BandwidthMeter;
using IPConfigReleaseRenewMode = Models.Network.IPConfigReleaseRenewMode;
using NetworkInterfaceConfig = Models.Network.NetworkInterfaceConfig;
using NetworkInterfaceInfo = Models.Network.NetworkInterfaceInfo;
using Subnetmask = Models.Network.Subnetmask;
...
public class NetworkInterfaceViewModel : ViewModelBase, IProfileManager
{
    ...
    private async Task ApplyConfiguration()
    {
        ...
        try
        {
            var networkInterface = new Network_NetworkInterface();
    ...
    private async Task FlushDNSAsync()
    {
        ...
        await Network_NetworkInterface.FlushDnsAsync();
    ...
    private async Task ReleaseRenewAsync(IPConfigReleaseRenewMode releaseRenewMode)
    {
        ...
        await Network_NetworkInterface.ReleaseRenewAsync(releaseRenewMode, SelectedNetworkInterface.Name);
    ...
    private async Task AddIPv4Address(string ipAddress, string subnetmaskOrCidr)
    {
        ...
        try
        {
            await Network_NetworkInterface.AddIPAddressToNetworkInterfaceAsync(config);
    ...
    private async Task RemoveIPv4Address(string ipAddress)
    {
        ...
        try
        {
            await Network_NetworkInterface.RemoveIPAddressFromNetworkInterfaceAsync(config);
