...
namespace Ninja.Models
{
    public static class SnifferStatsProcess
    {
        ...
        public static void Start()
        {
            ...
            foreach (SnifferStatsModel.Ipv4ProtocolStats stat in ProtocolStats)
            {
                stat.ByteCount = 0;
                stat.PacketCount = 0;
            }
        ...
        static SnifferStatsProcess()
        {
            ...
            ProtocolStats = new ObservableCollection<SnifferStatsModel.Ipv4ProtocolStats>()
            {
                new SnifferStatsModel.Ipv4ProtocolStats( IpV4Protocol.Tcp),
                new SnifferStatsModel.Ipv4ProtocolStats( IpV4Protocol.Udp),
                new SnifferStatsModel.Ipv4ProtocolStats( IpV4Protocol.Ip),
                new SnifferStatsModel.Ipv4ProtocolStats( IpV4Protocol.Stream),
